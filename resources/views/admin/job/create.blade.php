                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb" class="bg-light p-3 rounded shadow-sm">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">Create New Job</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card-body p-4">
                                <form action="{{ route('job.store') }}" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="row g-4">
                                                ...
                                                @if ($employee_skills->count() > 0)
                                                    @foreach ($employee_skills as $skill)
                                                        <option value="{{ $skill->id }}" 
                                                                @if(in_array($skill->id, old('skills', []))) selected @endif>
                                                            {{ $skill->name }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control" id="no_of_vacancy"
                                                name="no_of_vacancy" value="{{ old('no_of_vacancy') }}" required
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="job_location"
                                                name="job_location" value="{{ old('job_location') }}" required
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="offered_salary"
                                                    name="offered_salary" value="{{ old('offered_salary') }}"
                                        ...
                                        <div class="col-md-6">
                                            <label for="degree_id" class="form-label">Required Degree
                                                (Optional)</label>
                                        ...
                                        <div class="col-12">
                                            <label for="other_specification" class="form-label">Other Specifications
                                                (Optional)</label>
                                            <textarea class="form-control" id="other_specification" name="other_specification" rows="3">{{ old('other_specification') }}</textarea>
                                    ...
                                    <div class="mt-5 d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary px-4">Create Job
                                            Posting</button>
                                    </div>
                                </form>
                            </div>
