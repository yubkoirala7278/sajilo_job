    ...
    $(document).ready(function() {
        var table = $('#employees-table').DataTable({
            ...
            columns: [
                ...
                { data: 'school_or_college_or_institute', name: 'school_or_college_or_institute' },
                { data: 'is_currently_studying', name: 'is_currently_studying' },
                { data: 'grade_type', name: 'grade_type' },
                { data: 'mark_secured', name: 'mark_secured' },
                { data: 'graduation_year', name: 'graduation_year' },
                { data: 'graduation_month', name: 'graduation_month' },
                { data: 'education_started_year', name: 'education_started_year' },
                { data: 'education_started_month', name: 'education_started_month' },
