                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <ul class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('job_category.index') }}" style="color: #2C3E50">Category</a>
                            </li>
                        </ul>
                        <a href="{{ route('job_category.create') }}" class="btn text-white btn-sm rounded-pill px-3 py-2"
            ...
            $(document).on('click', '.toggle-status-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/admin/job_category/toggle-status/${slug}`,
                            type: 'PATCH',
                            data: {
                                status: newStatus,
                                _token: '{{ csrf_token() }}',
