                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <ul class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('job_title.index') }}" style="color: #2C3E50">Job Title</a>
                            </li>
                        </ul>
                        <a href="{{ route('job_title.create') }}" class="btn text-white btn-sm rounded-pill px-3 py-2"
                            style="background-color: #2C3E50">Create</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table title-datatable table-hover pt-3 w-100">
                            <thead>
                                <tr>
                                    <th>S.N:</th>
                                    <th>Job Title</th>
            ...
            $(document).on('click', '.toggle-status-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/admin/job_title/toggle-status/${slug}`,
                            type: 'PATCH',
                            data: {
                                status: newStatus,
                                _token: '{{ csrf_token() }}',
