...
@section('content')
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider slider-height d-flex align-items-center"
                    data-background="{{ asset('public/assets/img/hero/h1_hero.jpg') }}">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                ...
                                <form action="#" class="search-box">
                                    <div class="input-form">
                                        <input type="text" placeholder="Enter Skill or Job Seeker Detail">
                                    </div>
                                    <div class="select-form">
                                        <div class="select-itms">
                                            <select name="select" id="select1">
                                                ...
                                                <option value="">Birtanagar</option>
                                                <option value="">Dharan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="search-form">
                                        <a href="{{ route('job.seekers') }}">Find Job Seeker</a>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="online-cv cv-bg section-overly pt-90 pb-120"
            data-background="{{ asset('public/assets/img/gallery/cv_bg.jpg') }}">
            <div class="container">
                    ...
                    <div class="col-xl-10">
                            ...
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img
                                            src="{{ asset('public/assets/img/icon/job-list1.png') }}" alt=""></a>
                                </div>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img
                                            src="{{ asset('public/assets/img/icon/job-list2.png') }}" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="job_details.html">
                                        <h4>Digital Marketer</h4>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img
                                            src="{{ asset('public/assets/img/icon/job-list3.png') }}" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="job_details.html">
                                        <h4>Digital Marketer</h4>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img
                                            src="{{ asset('public/assets/img/icon/job-list4.png') }}" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="job_details.html">
                                        <h4>Digital Marketer</h4>
        ...
        <div class="apply-process-area apply-bg pt-150 pb-150"
            data-background="{{ asset('public/assets/img/gallery/how-applybg.png') }}">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder  ">
                                        <div class="founder-img mb-30">
                                            <img src="{{ asset('public/assets/img/testmonial/testimonial-founder.png') }}"
                                                alt="">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="support-location-img">
                            <img src="{{ asset('public/assets/img/service/support-img.jpg') }}" alt="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{ asset('public/assets/img/blog/home-blog1.jpg') }}" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{ asset('public/assets/img/blog/home-blog2.jpg') }}" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
