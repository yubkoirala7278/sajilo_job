            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="info-grid mb-5">
                            <div class="info-item">
                                <span class="info-label"><i class="fas fa-signal me-2"></i>Approval Status</span>
                                <span class="status-badge {{ $job->is_approved === 'approved' ? 'bg-success text-white' : ($job->is_approved === 'pending' ? 'bg-warning text-dark' : 'bg-danger text-white') }}">
                                    {{ ucfirst($job->is_approved) }}
                                </span>
                            </div>
                            <div class="info-item">
