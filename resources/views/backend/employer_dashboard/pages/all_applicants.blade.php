    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-striped" id="all-applicants-table">
...
@push('script')
    <script>
        $(document).ready(function() {
            $('#all-applicants-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("admin.all.applicants") }}',
                columns: [
...
<style>
    ...
    .dataTables_wrapper .dataTables_paginate .paginate_button.current { background: #007bff; color: white !important; }
</style>
@endsection