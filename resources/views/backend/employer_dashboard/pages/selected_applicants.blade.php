...
<div class="container mt-3">
    <div class="card shadow-sm">
        <div class="card-header bg-success text-white">
            <h4 class="mb-0">Selected Applicants</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-striped" id="selected-applicants-table">
...
@push('script')
    <script>
        $(document).ready(function() {
            $('#selected-applicants-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("admin.selected.applicants") }}',
                columns: [
