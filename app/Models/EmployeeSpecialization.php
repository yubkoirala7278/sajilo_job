...
class EmployeeSpecialization extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($employee_specialization) {
            $employee_specialization->slug = self::generateUniqueSlug();
        });
    }
    ...
    {
        return $this->belongsToMany(Employee::class, 'employee_employee_specialization', 'employee_specialization_id', 'employee_id');
    }
}
